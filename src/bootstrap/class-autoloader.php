<?php
/**
 * BP Skeleton Autoload Implementation.
 *
...
/**
 * Auto Loader for Recent_Post_Visitors.
 *
 * After registering this autoload function with SPL, the following line
 * would cause the function to attempt to load the Recent_Post_Visitors\Bar\Baz\Qux class
 * from /path/to/wp-content/plugins/bp-skeleton/src/bar/baz/class-qux.php:
 *
 *      new Recent_Post_Visitors\Baz_Xyz\Qux;
 *  maps to /path/to/wp-content/plugins/bp-skeleton/src/bar/baz-xyz/class-qux.php
...
class Autoloader {
	...
	/**
	 * Namespace root. eg. Recent_Post_Visitors\\(escaped slashes);
	 *
	 * @var string
	 */
